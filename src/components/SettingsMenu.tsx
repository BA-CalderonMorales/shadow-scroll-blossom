...
export const SettingsMenu = () => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50">
      ...
      {/* Settings Panel */}
      {isOpen && (
        <div className="absolute top-10 right-0 w-80 h-96 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-sm shadow-lg flex flex-col">
